...
const HeroBanner = ({pageTitle,pageName,pageDesc}) => {
  return (
    <div className='bg-linear-to-r from-purple-900 via-purple-700 to-yellow-500 backdrop-blur-2xl flex flex-col items-center justify-center pt-20 pb-10 text-center'>
